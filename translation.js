export const translations = {
    CS: {
        ...
        skillsMLE: "ML Engineering (Databázové systémy, Docker, FastAPI, Deployment, GitHub Actions)",
        skillsMCMC: "MCMC Simulace",
        skillsStat: "Statistika (+ Ekonometrie, Modely časových řad, Bayesiánská analýza)",
        filters: ["Vše", "Strojové učení", "ML Engineering", "Data Science & Statistika", "Webový vývoj"],
        projectsTitle: "Projekty",
        footerText: "© 2026 Václav Jež. Všechna práva vyhrazena.",
        ...
        project_desc_2: `
            ...
            <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px;">
                ...
                <li><strong>Databáze:</strong> PostgreSQL s rozšířením <code>pgvector</code> (Neon.tech) pro vektorové vyhledávání.</li>
                <li><strong>AI Model:</strong> ChatGPT (přes API) dostává relevantní kontext vyhledaný pomocí sémantické podobnosti.</li>
                <li><strong>Frontend & Deploy:</strong> UI vytvořené v <strong>Streamlit</strong>, aplikace je kontejnerizována v <strong>Dockeru</strong> a hostována na Hugging Face Spaces.</li>
            </ul>
        ...
        project_desc_4: `
            ...
            <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px;">
                <li><strong>Market-aware:</strong> Automaticky detekuje časové zóny burz a filtruje neuzavřené dny (US Equities, Crypto, Forex, atd.).</li>
                <li><strong>Forecasting Ready:</strong> Automaticky vypočítává cílové datum pro predikce (next business day).</li>
                <li><strong>Stabilita:</strong> Wrapper nad <code>yfinance</code> s robustním ošetřením chyb a retry logikou.</li>
            </ul>
        ...
        project_desc_6: `
            ...
            <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px;">
                ...
                <li>Vlastní custom funkce napsána from scratch pro výpočet funkcí impulsních odezev (IRF) pro exogenní proměnné (R neobsahuje).</li>
            </ul>
        ...
        project_title_7: "Predikce cen akcií v simulované kolektivní VŠ hře",
        project_desc_7: `
    ...
    EN: {
        ...
        skillsMLE: "ML Engineering (Database systems, Docker, FastAPI, Deployment, GitHub Actions)",
        skillsMCMC: "MCMC Simulations",
        skillsStat: "Statistics (+ Econometrics, Time Series Models, Bayesian Analysis)",
        filters: ["All", "Machine Learning", "ML Engineering", "Data Science & Statistics", "Web Development"],
        projectsTitle: "Projects",
        footerText: "© 2026 Václav Jež. All rights reserved.",
        ...
        project_desc_2: `
            ...
            <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px;">
                ...
                <li><strong>Database:</strong> PostgreSQL with <code>pgvector</code> (Neon.tech) for vector similarity search.</li>
                <li><strong>AI Model:</strong> ChatGPT (via API) receives relevant context retrieved via semantic similarity.</li>
                <li><strong>Frontend & Deploy:</strong> Interactive UI built with <strong>Streamlit</strong>, containerized in <strong>Docker</strong>, and hosted on Hugging Face Spaces.</li>
            </ul>
        ...
        project_desc_4: `
            ...
            <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px;">
                <li><strong>Market-aware:</strong> Automatically identifies exchange timezones and filters out incomplete days (US Equities, Crypto, Forex, etc.).</li>
                <li><strong>Forecasting Prep:</strong> Automatically computes the next valid trading day for predictive labeling.</li>
                <li><strong>Resiliency:</strong> A smart wrapper around <code>yfinance</code> with robust error handling and retry logic.</li>
            </ul>
            <strong>Tech Stack:</strong> Python, Pandas, yfinance, pytz.
            <br>
        ...
        project_desc_6: `
            ...
            <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px;">
                ...
                <li>Developed custom functions for computing Impulse Response Functions (IRF) for exogenous variables.</li>
            </ul>
            <a href='https://is.muni.cz/th/dzkyy/?fakulta=1421;obdobi=181;lang=cs;id=300358' target='_blank'>Thesis available at IS MU</a>
        `,

        project_title_7: "Stock Price Prediction in Simulated University Game",
        project_desc_7: `
        ...
        project_title_8: "FitApp: Calorie and Activity Manager",
        project_desc_8: `
